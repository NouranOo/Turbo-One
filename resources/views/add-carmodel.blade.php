                    ...
                    <div class="content">
                        ...
                        <div class="widget">
                            <div class="widget-content">
                                <form method="post" action="{{route('addmodels')}}"  enctype="multipart/form-data" onsubmit="return modelValidation()" name="model">
                                                   @csrf
                                    ...
                                    <div class="col-md-8 col-sm-7">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="modelname_ar"> 
                                    ...
                                    <div class="col-sm-12 save-btn">
                                        <button class="custom-btn green-bc">add model</button>
                                    </div>
                                </form>
                            </div>
                        </div>
