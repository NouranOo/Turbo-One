                    ...
                    <div class="content">
                        ...
                        <div class="widget">
                            <div class="widget-content">
                                <form method="post" action="{{route('addpromo')}}"  enctype="multipart/form-data" onsubmit="return promoValidation()" name="promocode">
                                                   @csrf
                                    ...
                                    <div class="col-sm-12 save-btn">
                                        <button class="custom-btn green-bc">add promo code</button>
                                    </div>
                                </form>
                            </div>
                        </div>
