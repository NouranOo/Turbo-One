                    ...
                    <div class="content">
                        ...
                        <div class="widget">
                            <div class="widget-content">
                                <form method="post" action="{{route('editcar',[$brands->id])}}"  enctype="multipart/form-data" onsubmit="return brandValidation()" name="brand">
                                                   @csrf
                                    <div class="col-md-8 col-sm-7">
                                        <div class="col-md-8 col-sm-7">
                                        <div class="form-group">
                                            <label>car brand_en : </label>
                                            <input class="form-control" type="text" name="name" value="{{$brands->Name_en}}"> 
                                    ...
                                    <div class="col-md-8 col-sm-7">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="name_ar" value="{{$brands->Name_ar}}"> 
                                    ...
                                    <div class="col-sm-12 save-btn">
                                        <button class="custom-btn green-bc">edit brand</button>
                                    </div>
                                </form>
                            </div>
                        </div>
